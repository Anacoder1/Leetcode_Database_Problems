...
The TIV_2015 value '10' is as the same as the third and fourth record, and its location unique.
...
Use a WHERE statement to select the entries that meet the 2 criteria.

For criterion 1, there should be > 1 entry with the same value of field TIV_2015.

For criterion 2, there should be exactly 1 entry of the values LAT and LON.
```
<br>
