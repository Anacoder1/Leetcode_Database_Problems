...
First, calculate the average quantity using ALL.

Then select the order_ids where the maximum quantity is greater than the average quantity.
```
<br>
...
(1, 1, 12), (1, 2, 10), (1, 3, 15), (2, 1, 8),
(2, 4, 4), (2, 5, 6), (3, 3, 5), (3, 4, 18),
(4, 5, 2), (4, 6, 8), (5, 7, 9), (5, 8, 9),
(3, 9, 20), (2, 9, 4);
